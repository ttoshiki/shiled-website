            ...
            <div class="singleProduct__productInfo">
              ...
              <div class="singleProduct__meta">
                ...
                <div class="singleProduct__buttons">
                  <?php if (get_field('shopify-code1')): ?>
                    <?php the_field('shopify-code1'); ?>
                  <?php endif; ?>
                  <a href="<?php echo home_url('/contact/') ?>" class="c-btn -contact"><span class="c-btn__text">お問い合わせ</span></a>
                </div>
              </div>
            </div>
              ...
              <div class="singleProduct-doubleCol__col -fixed">
                <div class="singleProduct__fixedInfo">
                  ...
                  <div class="singleProduct__fixedInfoButtons">
                    <?php if (get_field('shopify-code2')): ?>
                      <?php the_field('shopify-code2'); ?>
                    <?php endif; ?>
