...
?>
	...
	<main class="site-main">
      ...
      <section class="service__price">
        ...
        <div class="service__priceContents">
          ...
          <table class="service__priceTable">
            ...
            <tbody>
              ...
              <tr>
                <td>A+B　除菌・清掃+除菌コート</td>
                <td>500㎡辺り　500,000円〜（1,000円／㎡〜）</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section class="service__feature">
        <div class="service__featureInner">
          <h2 class="service__heading"><span id="effect_03">&SHIELD抗菌コーティング<br class="-sp">&除菌清掃サービスの特徴</span></h2>
      ...
      <section class="service__flow">
        <div class="service__flowInner">
          <h2 class="service__heading"><span id="effect_04">施工の主な流れ</span></h2>
          <div class="service__flowSteps">
            ...
            <div class="service__flowStep fadein">
              ...
              <p class="service__flowStepParagraph">作業場所室内全体に弱酸性次亜塩素酸水または除菌洗浄剤を噴霧。室内の壁など普段清掃が行き届きにくい箇所も清掃、除菌することが可能。</p>
            </div>
            <div class="service__flowStep fadein">
      ...
      <section class="service__coronaFlow">
        <h2 class="service__heading"><span id="effect_08">コロナ感染発覚時緊急対策<br class="-sp">フロー策定</span></h2>
        <p class="service__headingParagraph">お客様、従業員様でコロナ感染の発覚時から、<br class="-pc">各所除菌対策フローを作成、再営業開始までの除菌計画をご提案します。</p>
      ...
      <section class="service__coatingFeature">
        <h2 class="service__heading"><span id="effect_05">&SHIELD抗菌コーティングの特徴</span></h2>
        <p class="service__headingParagraph">光触媒コーティングで長期間に渡り「安心・快適な空間作り」に貢献いたします。</p>
      ...
      <section class="service__execution">
        <h2 class="service__heading"><span id="effect_05">持続性の高い「&SHIELD抗菌コーティング施工」</span></h2>
        <p class="service__headingParagraph">
        ...
        <div class="service__foldWrapper">
          ...
          <div class="service__foldContents">
            <div class="service__executionContents">
              <div class="service__heading">メディカルナノコート</div>
              <p class="service__foldParagraph">壁面等に塗布することで、細菌・ウイルスを破壊し、<br>カビの発生を抑制する特殊被膜ナノコーティング剤。</p>
            </div>
            <button class="service__executionButton service__foldButton">OPEN</button>
          </div>
        </div>
      </section>
      <section class="service__nanoCoat">
        <h2 class="service__heading service__nanoCoatHeading"><span id="effect_06">抗菌コーティング「メディカルナノコート」とは？</span></h2>
      ...
      <section class="service__verification">
        <div class="service__verificationInner">
          <h2 class="service__heading service__verificationHeading"><span id="effect_07">第三者機関での検証</span></h2>
      ...
      <section class="service__achievement">
        <h2 class="service__heading"><span id="effect_09">導入実績</span></h2>
        <p class="service__headingParagraph">羽田空港、関西空港、市役所などの公共施設、<br class="-pc">またホテルなどのエレベーター内の感染予防として導入</p>
        ...
        <p class="service__headingParagraph -place">不特定多数の方が触る場所への施工</p>
        <div class="service__achievementPlace">
          <figure class="service__achievementFigure fadein">
      ...
      <section class="service__nanozoneCoat">
        <div class="service__foldWrapper">
          <div class="service__foldContents">
            <h2 class="service__heading">nanozoneCOAT</h2>
            <p class="service__foldParagraph">
              自己結合性酸化チタン分散液（＝ナノゾーンソリューション）<br>
              を塗布する光触媒コーティング施工です。
            </p>
            <button class="service__nanozoneCoatButton service__foldButton">OPEN</button>
          </div>
          <picture class="service__foldPicture">
        ...
        <div class="service__aboutNanoCoat">
          <h2 class="service__heading">“nanozone COAT”（ナノゾーンコート）とは？</h2>
          <div class="service__aboutNanoCoatContents">
        ...
        <div class="service__nanoCoatCase">
          <div class="service__nanoCoatCaseBlock">
            <span class="service__nanoCoatCaseLabel">店舗<span class="service__newLine">施工</span></span>
            <h2 class="service__nanoCoatCaseHeading">対象：店舗・オフィス</h2>
            <div class="service__nanoCoatCaseContents">
          ...
          <div class="service__nanoCoatCaseBlock">
            <span class="service__nanoCoatCaseLabel">施工<span class="service__newLine">事例</span></span>
            <div class="service__nanoCoatCaseInner">
              <div class="service__nanoCoatCaseUpper">
                <div>
              ...
              <div class="service__nanoCoatCaseLower">
                <ul class="service__nanoCoatCaseListBlock">
                  ...
                  <li class="service__nanoCoatCaseItemBlock">
                    <h3 class="service__nanoCoatCaseItemHeading">券機・タッチパネル</h3>
                    <picture class="service__nanoCoatCasePicture -before">
          ...
          <div class="service__nanoCoatCaseBlock -verification">
      ...
      <section class="service__merit">
        <h2 class="service__heading"><span id="effect_05">除菌清掃&抗菌コートのメリット</span></h2>
        <p class="service__headingParagraph">光触媒コーティングで長期間に渡り「安心・快適な空間作り」に貢献いたします。</p>
        <div class="service__coatingFeatures">
      ...
      <section class="service__contactLink">
        <h2 class="service__heading contact"><span id="effect_10">お問い合わせはこちら</span></h2>
