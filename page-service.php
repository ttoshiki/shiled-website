	...
	<main class="site-main">
        ...
        <div class="service__priceContents fadein">
          ...
          <table class="priceTable -service">
            ...
            <tbody>
              ...
              <tr>
                <td><strong>B　抗菌コート</strong></td>
                <td><strong>500㎡辺り　250,000円〜（500円／㎡〜）</strong></td>
              </tr>
              <tr>
                <td><strong><span class="price__tableCourse">A+B</span><span>除菌・清掃+抗菌コート</span></strong></td>
      ...
      <section class="service__feature">
        <div class="service__featureInner">
          <h2 class="service__heading"><span id="effect_04">&SHIELD抗菌コーティング<br class="-sp">&除菌清掃サービスの特長</span></h2>
          <div class="service__featurePoints">
            ...
            <div class="service__featurePoint fadein">
              ...
              <p class="service__featurePointParagraph">保証：施工後、従業員様コロナ感染発覚時作業を50%引きで実施いたします。</p>
            </div>
          </div>
      ...
      <section class="service__execution">
        ...
        <p class="service__headingParagraph -foldBefore fadein">
          私たち &SHIELDはお客様の施工規模、利用動線、活動人数に合わせ最適なご提案をいたします。<br class="-pc">
          抗菌コーティング剤はナスクナノテクノロジー社の「メディカルナノコート」を使用いたします。
        </p>
